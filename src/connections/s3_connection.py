...
from src.constants import AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY, S3_BUCKET_NAME, AWS_REGION_NAME
...
#     FILE_KEY = "spam.csv"  # Path inside S3 bucket

#     data_ingestion = s3_operations(S3_BUCKET_NAME, AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY, AWS_REGION_NAME)
